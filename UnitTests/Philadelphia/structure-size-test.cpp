...
BOOST_AUTO_TEST_CASE (tst_doc_document_key_marker) {
  ...
  BOOST_CHECK_EQUAL(24, offsetof(struct TRI_doc_document_key_marker_s, _tid));
  BOOST_CHECK_EQUAL(32, offsetof(struct TRI_doc_document_key_marker_s, _shape));
  BOOST_CHECK_EQUAL(40, offsetof(struct TRI_doc_document_key_marker_s, _offsetKey));
  BOOST_CHECK_EQUAL(42, offsetof(struct TRI_doc_document_key_marker_s, _offsetJson));
}
...
BOOST_AUTO_TEST_CASE (tst_doc_edge_key_marker) {
  ...
  BOOST_CHECK_EQUAL(24 + 24 + 24, s); // base + own size
  BOOST_CHECK_EQUAL(true, s % 8 == 0); 

  BOOST_CHECK_EQUAL( 0, offsetof(struct TRI_doc_edge_key_marker_s, base));
  BOOST_CHECK_EQUAL(48, offsetof(struct TRI_doc_edge_key_marker_s, _toCid));
  BOOST_CHECK_EQUAL(56, offsetof(struct TRI_doc_edge_key_marker_s, _fromCid));
  BOOST_CHECK_EQUAL(64, offsetof(struct TRI_doc_edge_key_marker_s, _offsetToKey));
  BOOST_CHECK_EQUAL(66, offsetof(struct TRI_doc_edge_key_marker_s, _offsetFromKey));
}

////////////////////////////////////////////////////////////////////////////////
/// @brief test sizeof TRI_doc_deletion_key_marker_t
////////////////////////////////////////////////////////////////////////////////
